...
('DEP005', 'Public Services');

-- Divisions
INSERT INTO divisions (div_id, name, dep_id) VALUES 
('DIV001', 'General Administration', 'DEP001'),
('DIV002', 'Accounting', 'DEP002'),
('DIV003', 'System Management', 'DEP003'),
('DIV004', 'Staff Management', 'DEP004'),
('DIV005', 'Birth Certificates', 'DEP005'),
('DIV006', 'Death Certificates', 'DEP005'),
('DIV007', 'Marriage Certificates', 'DEP005'),
('DIV008', 'Land Records', 'DEP005');

-- Default Admin User
INSERT INTO users (user_id, name, post, dep_id, div_id, role, username, password) VALUES 
('USR001', 'System Administrator', 'Admin', 'DEP003', 'DIV003', 'Admin', 'admin', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi');

-- Reception Staff
INSERT INTO users (user_id, name, post, dep_id, div_id, role, username, password) VALUES 
('USR002', 'Reception Officer', 'Front Desk Officer', 'DEP001', 'DIV001', 'Reception_Staff', 'reception', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi');

-- Subject Staff
INSERT INTO subject_staff (sub_id, name, post, dep_id, username, password) VALUES 
('SUB001', 'Certificate Officer', 'Senior Officer', 'DEP005', 'certofficer', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi'),
('SUB002', 'Document Specialist', 'Assistant Officer', 'DEP001', 'docspec', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi');
...
JOIN divisions div ON a.div_id = div.div_id
...
JOIN divisions div ON tm.div_id = div.div_id;
...
JOIN divisions div ON pr.div_id = div.div_id
